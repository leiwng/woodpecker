...
def contour_bbox_img(img, contour, padding=1):
    """
    ...
    Returns:
        ori_cropped: bbox cropped from img.
        gray_cropped: bbox cropped from gray img of img.
        wbg_cropped: bbox cropped from img, with white background.
    """
    ...
    np.copyto(wbg_cropped, gray_cropped, where=(gray_cropped > 0))

    return ori_cropped, gray_cropped, wbg_cropped
